...
import { User, BorrowedBook, Reservation, 
  Fine
 } from "../types";
...
export const getFinesForUserWithId = (id: String | undefined) =>
  entityService.getRelatedEntityItemsForThisEntityWithId<Fine>(id, 'fines');
/*
